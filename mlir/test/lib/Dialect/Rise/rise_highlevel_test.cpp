...
TEST_FUNC(test_conv2) {
  ...
  makeRiseTest(f, {height, width}, getFilledMemRef({height, width}),
               getFilledMemRef({kernelHeight, kernelWidth}, 0.5f));
...
TEST_FUNC(test_conv2_separable) {
  ...
  makeRiseTest(f, {height, width}, getFilledMemRef({height, width}),
               getFilledMemRef({3}, 0.5f), getFilledMemRef({3}, 0.5f));
