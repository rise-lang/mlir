...
func @array_times_2() {
    ...
    %outputArray = memref.alloc() : memref<15x122xf32>
    %inputArray = memref.alloc() : memref<15x122xf32>
    ...
    scf.for %arg0 = %c0 to %c3 step %c1 {
        scf.for %arg1 = %c0 to %c2 step %c1 {
            ...
            memref.store %interm, %inputArray[%arg0, %arg1] : memref<15x122xf32>
        }
    }

    call @rise_fun(%outputArray, %inputArray) : (memref<15x122xf32>, memref<15x122xf32>) -> ()

    %print_me = memref.cast %outputArray : memref<15x122xf32> to memref<*xf32>
    %print_me_input = memref.cast %inputArray : memref<15x122xf32> to memref<*xf32>
